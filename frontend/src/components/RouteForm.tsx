...
const RouteForm = ({ toggleRequirements }: RouteFormProps) => {
    ...
    const addToIntermediateList = useIntermediateListStore(
        (state) => state.addToIntermediateList,
    );
    const removeFromIntermediateList = useIntermediateListStore(
        (state) => state.removeFromIntermediateList,
    );
        ...
        <form onSubmit={handleCompute}>
            ...
            <div className="inputLine">
                ...
                <button
                    ...
                    onClick={() =>
                        originRef.current &&
                        handleLocate(originRef.current.value)
                    }
                >
                    <LocationOnIcon />
                </button>
